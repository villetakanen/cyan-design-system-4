...
<section class="column-s surface">
### Semantic mess?

  <article class="surface debug">
    <h4>We support articles inside</h4>
    <img class="poster" src="https://picsum.photos/400/225" alt="Placeholder image"/>
    <p>sections, like this one, with classes surface and debug. The padding here
      comes from the surface defaults.</p>
  </article>
</section>